...
- [<i class="fas fa-file-pdf"></i> `Download as PDF`](/r/1.2-r-practice.pdf)
- [<i class="fas fa-external-link-square-alt"></i> `Answer Key (html)`](/r/1.2-r-practice-answers.html)
- [<i class="fas fa-file-pdf"></i> `Answer Key (PDF)`](/r/1.2-r-practice-answers-pdf.pdf)
- [<i class="fas fa-registered"></i> `R Script`](/r/1.2-r-practice-answers.R)
