...
7. Now we are just exposing you to more `.Rmd` files. Look at the answer key for [1.4 R practice](/r/1.4-r-practice) and download and open the <i class="fab fa-markdown"></i> `.Rmd` file. Take a look through it and see how it works, then when you are ready, click the `knit` button. It will make the `html` webpage (which you can open in any browser) that is identical to the answer key web page I made!

8. Look at the <i class="fab fa-markdown"></i> `.Rmd` file in this week's [homework assignment](/assignment/01-problem-set). If you want, you can complete this using that file. 