...
- [<i class="fas fa-cloud"></i> View Project on R Studio Cloud](https://rstudio.cloud/spaces/83147/project/1539899)
- [<i class="fas fa-file-pdf"></i> `Download as PDF`](/r/1.3-r-practice.pdf)
- [<i class="fas fa-external-link-square-alt"></i> `Answer Key (html)`](/r/1.3-r-practice-answers.html)
- [<i class="fas fa-file-pdf"></i> `Answer Key (PDF)`](/r/1.3-r-practice-answers-pdf.pdf)
- [<i class="fas fa-registered"></i> `R Script`](/r/1.3-r-practice-answers.R) -->
