...
- [<i class="fas fa-external-link-alt"></i> html](/assignments/03-problem-set-answers.html)
- [<i class="fab fa-markdown"></i> Download Markdown](/assignments/03-problem-set-answers.Rmd)
- [<i class="fas fa-registered"></i> `R` Script`](/assignments/03-problem-set-answers.R)
