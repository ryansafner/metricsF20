...
We are returning to the speeding tickets data that we began to explore in [R Practice 15 on Multivariate Regression](http://metricsf20.classes.ryansafner.com/practice/15-practice). Download and read in (`read_csv`) the data below. 

- [<i class="fas fa-table"></i> `speeding_tickets.csv`](http://metricsf20.classes.ryansafner.com/data/speeding_tickets.csv)
...
```{r}
library(tidyverse)
speed<-read_csv("http://metricsf20.classes.ryansafner.com/Data/speeding_tickets.csv")
```
