...
- Example on right is what I commonly use in my slides:
  ...
  - hide all messages and warnings (from slides)
  - make figure resolution
]
]
...
.pull-left[
.center[
![:scale 50%](../images/projectswitcher2.png)
]
...
.pull-right[
.center[
![:scale 40%](../images/projectlist2.png)
]
...
.center[
![:scale 70%](../images/github%202.png)
]
...
.center[
![:scale 75%](../images/mydropbox2.png)
...
.center[
![:scale 75%](../images/dropboxsmartsync.png)
...
.center[
[github.com/ryansafner/metricsF20](http://github.com/ryansafner/metricsF20)
]
---
