...
1. Problem for **identification**: .hi[endogeneity]

2. Problem for **inference**: .hi[randomness]
...
- An independent variable $(X)$ is .hi[exogenous] if its variation is *unrelated* to other factors that affect the dependent variable $(Y)$

- An independent variable $(X)$ is .hi[endogenous] if its variation is *related* to other factors that affect the dependent variable $(Y)$
]
...
- We want to .hi-purple[identify] causal relationships between **population** variables
